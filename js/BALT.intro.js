 ...
 * @requires BALT
 */
BALT.Intro = (function(BALT, self, window, undefined){
	...
	/**
	 * @name BALT.Intro-_initialize
	 * @exports BALT.Intro-_initialize as BALT.Intro.initialize
	 * @function
	 * @description
	...
	/**
	 * @name BALT.Intro-_start
	 * @exports BALT.Intro-_start as BALT.Intro.start
	 * @function
	 * @description
	 */
	_start = function() {
	...
	/**
	 * @name BALT.Intro-_stepOne
	 * @exports BALT.Intro-_stepOne as BALT.Intro.stepOne
	 * @function
	 * @description
	 */
	_stepOne = function() {
	...
	/**
	 * @name BALT.Intro-_done
	 * @exports BALT.Intro-_done as BALT.Intro.done
	 * @function
	 * @description
	 */
	_done = function() {
...
}(BALT, BALT.Intro || {}, window, undefined));